...
export function IconCalendarMini({ size = 24 }: IconProps) {
  return (
    <svg {...wrap(size)}>
      <rect x="3" y="6" width="18" height="15" rx="2.5" fill="#B18CFF" />
      <rect x="3" y="6" width="18" height="4.5" rx="2.5" fill="#8037FF" />
  ...
  return (
    <svg {...wrap(size)}>
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="5" cy="3" r="1.3" fill="#8037FF" />
      <circle cx="14" cy="3" r="1.3" fill="#8037FF" />
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="17.5" cy="12.5" r="2.8" fill="#B18CFF" />
...
export function IconSearch({ size = 24 }: IconProps) {
  return (
    <svg {...wrap(size)}>
      <circle cx="10.5" cy="10.5" r="6.2" fill="none" stroke="#8037FF" strokeWidth="2.2" />
      <line x1="15" y1="15" x2="20" y2="20" stroke="#8037FF" strokeWidth="2.4" strokeLinecap="round" />
      <circle cx="10.5" cy="10.5" r="3" fill="#EDE9FE" />
    </svg>
  );
}
...
export function IconArrowUp({ size = 24 }: IconProps) {
  return (
    <svg {...wrap(size)}>
      <circle cx="12" cy="12" r="10" fill="#8037FF" />
