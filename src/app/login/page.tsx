    ...
    <div className="min-h-screen bg-white max-w-[480px] mx-auto flex flex-col">
      ...
      <div className="px-6 pb-12 space-y-3 fade-in-up-delay-2">
        <button
          ...
          className="w-full py-3.5 bg-[#FEE500] text-[#3C1E1E] rounded-xl font-medium flex items-center justify-center gap-2 text-sm hover:bg-[#FDD835] transition-colors btn-press disabled:opacity-60"
        >
        ...
        <button
          ...
          disabled={pending !== null}
          className="w-full py-3.5 bg-black text-white rounded-xl font-medium flex items-center justify-center gap-2 text-sm hover:bg-gray-900 transition-colors btn-press disabled:opacity-60"
        >
