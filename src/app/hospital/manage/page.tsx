      ...
      <div className="min-h-screen bg-white max-w-[480px] mx-auto">
        ...
        <div className="flex flex-col items-center justify-center py-20 px-6">
          ...
          <Link
            ...
            className="px-6 py-3 bg-[#7C3AED] text-white rounded-xl text-sm font-bold btn-press"
          >
            병원 등록하기
          </Link>
        </div>
    ...
    <div className="py-3 space-y-3">
      ...
      <div className="bg-white">
        <div className="px-2.5 py-3 flex items-center justify-between">
          ...
          <Link href="/hospital/manage/doctor" className="text-[#7C3AED] text-xs font-bold">
            + 의료진 추가
          </Link>
        </div>
