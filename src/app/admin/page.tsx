...
export default function AdminDashboard() {
  ...
  const stats = [
    { label: '총 회원수', value: (s.totalUsers ?? 0).toLocaleString(), change: '', trend: 'up' as const, icon: Users, color: 'bg-purple-500' },
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm">
        <div className="flex items-center justify-between p-5 border-b border-gray-100">
          ...
          <a href="/admin/reservations" className="text-sm text-[#8037FF] hover:underline flex items-center gap-1">
            ...
            <tbody className="divide-y divide-gray-100">
              {recentReservations.map((res: any) => (
                <tr key={res.id} className="hover:bg-gray-50 transition-colors">
                  <td className="px-5 py-3 text-sm text-[#8037FF] font-medium">{res.id}</td>
